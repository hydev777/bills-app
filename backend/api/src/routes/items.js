...
router.get('/categories/:id', authenticateToken, async (req, res) => {
  try {
    ...
    const category = await ItemCategoryService.getCategoryById(id, includeItems === 'true');
...
router.put('/categories/:id', authenticateToken, async (req, res) => {
  try {
    ...
    const category = await ItemCategoryService.updateCategory(id, value);
    res.json(category);
  } catch (error) {
...
router.delete('/categories/:id', authenticateToken, async (req, res) => {
  try {
    ...
    const result = await ItemCategoryService.deleteCategory(id);
    res.json({
...
router.get('/categories/:id/stats', authenticateToken, async (req, res) => {
  try {
    ...
    const stats = await ItemCategoryService.getCategoryStats(id);
    res.json(stats);
  } catch (error) {
...
router.get('/:id/stats', authenticateToken, async (req, res) => {
  try {
    ...
    const stats = await ItemService.getItemStats(id);
    res.json(stats);
  } catch (error) {

---
name: flutter-master
description: Flutter project architecture, clean code, state management, and performance guidance. Use when Codex works on Flutter code in this project, especially for feature-first Clean Architecture, GetIt injection, Cubit/Bloc usage, Result/Failure error handling, reusable widgets, const usage, rebuild control, and lazy lists.
---
